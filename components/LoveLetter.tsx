    ...
    >
      ...
      <div className="max-w-3xl w-full relative">
        ...
        <motion.div 
            ...
            className="relative bg-white/40 backdrop-blur-xl p-8 md:p-14 shadow-2xl rounded-[3rem] border border-white/60 overflow-hidden"
        >
            {/* Inner Border */}
            <div className="absolute inset-4 border border-pink-200/50 rounded-[2.5rem] pointer-events-none" />
            ...
            >
                ...
                <h2 className="font-tajawal font-bold text-5xl md:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-rose-600 drop-shadow-sm relative z-10 pb-4">
                    إلى معشوقتي
                </h2>
            ...
            >
                {lines.map((line, index) => (
                    <motion.p
                        ...
                        className={`font-tajawal leading-loose ${
                            index === 0 
                                ? "font-bold text-pink-700 text-3xl md:text-4xl mb-6 drop-shadow-sm" 
                                : index === lines.length - 1 
                                    ? "font-aref text-4xl md:text-5xl text-rose-600 mt-10 pt-4" 
                                    : "text-xl md:text-2xl text-slate-800 font-medium"
                        }`}
                    >
                        {line}
                    </motion.p>
