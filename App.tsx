...
// Lazy load non-critical components to speed up initial load
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden text-right font-stc" dir="rtl">
      ...
      <AnimatePresence mode="wait">
        ...
        {screen === 'video' && (
          <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-pink-500">Loading Video...</div>}>
            <VideoPage
              key="video"
        ...
        {screen === 'letter' && (
          <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-pink-500">Loading Letter...</div>}>
            <LoveLetter
              key="letter"
        ...
        {screen === 'gallery' && (
          ...
          >
            ...
            <main className="w-full">
              <Suspense fallback={<div className="text-center py-10 text-pink-400">Loading Gallery...</div>}>
      ...
      {/* Audio Player Logic - Lazy Loaded */}
